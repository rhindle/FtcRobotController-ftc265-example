...
@TeleOp(name = "LK_FCD_IMUtest", group = "")
//@Disabled
public class LK_FCD_IMU extends LinearOpMode {
...
//        motor3.setDirection(DcMotorSimple.Direction.REVERSE);
    ...
    private void initIMU() {
        ...
        //LK added mode 4/4/2021
        //imuParameters.mode = BNO055IMU.SensorMode.IMU;
        imuParameters.mode = BNO055IMU.SensorMode.NDOF;
        imuParameters.calibrationDataFile = "LK_IMU_Calibration.json";
